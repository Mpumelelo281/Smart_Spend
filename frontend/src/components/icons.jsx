...
export function IconEyeOff({ className }) {
  return (
    <svg viewBox="0 0 24 24" className={className} {...base}>
      <path d="M3 3l18 18" />
      <path d="M10.6 5.2A10.6 10.6 0 0 1 12 5c6.4 0 10 7 10 7a15.6 15.6 0 0 1-3.4 4.2M6.6 6.6C4 8.3 2 12 2 12s3.6 7 10 7a9.7 9.7 0 0 0 4-.8" />
...
// Brand marks — multi-colour by nature, so these deliberately don't use
// the shared `base` (currentColor) stroke config the rest of icons.jsx
// uses; a Google/Microsoft logo isn't allowed to inherit a theme colour.
export function LogoGoogle({ className }) {
  return (
    <svg viewBox="0 0 24 24" className={className}>
      ...
      <path
        fill="#EA4335"
        d="M12 4.77c1.76 0 3.34.61 4.58 1.8l3.44-3.44C17.95 1.19 15.24 0 12 0A12 12 0 0 0 1.26 6.62l4.01 3.1C6.22 6.88 8.87 4.77 12 4.77Z"
      />
    </svg>
  );
}

export function LogoMicrosoft({ className }) {
  return (
    <svg viewBox="0 0 24 24" className={className}>
